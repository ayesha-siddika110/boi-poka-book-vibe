    ...
    return (
        <div className='work-sans flex justify-between items-center py-8 w-[90%] m-auto '>
            ...
            <div className='space-x-4'>
                <button className='border-2 border-white bg-green-500 hover:border-green-400 hover:bg-white ease-in hover:text-black py-3 px-4 rounded-xl text-white font-semibold'>Sign in</button>
